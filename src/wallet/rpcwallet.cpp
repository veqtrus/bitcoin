...
UniValue getnewaddress(const JSONRPCRequest& request)
{
    ...
    CTxDestination dest = pwallet->AddDestinationForKey(newKey, output_type);
...
UniValue getrawchangeaddress(const JSONRPCRequest& request)
{
    ...
    CTxDestination dest = pwallet->AddDestinationForKey(vchPubKey, output_type);
...
UniValue addmultisigaddress(const JSONRPCRequest& request)
{
    ...
    CTxDestination dest = pwallet->AddDestinationForScript(inner, g_address_type);
