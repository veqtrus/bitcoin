...
class AddressTypeTest(BitcoinTestFramework):
    ...
    def test_address(self, node, address, multisig, typ):
        ...
        elif not multisig and typ == 'p2sh':
            # P2SH-P2WPKH
    ...
    def run_test(self):
        ...
        self.test_address(1, self.nodes[1].addmultisigaddress(2, [compressed_1, compressed_2]), True, 'p2sh')
        self.test_address(2, self.nodes[2].addmultisigaddress(2, [compressed_1, compressed_2]), True, 'p2sh')
